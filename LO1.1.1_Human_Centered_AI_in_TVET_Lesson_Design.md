<!--
author: UNESCO ASSET Project Team
...
@scenarioBox: <div class="scenario-box">**Scenario:** @0</div>

@keyConceptBox: <div class="key-concept">**Key Concept:** @0</div>
...
<svg xmlns='http://www.w3.org/2000/svg' width='1100' height='400' viewBox='0 0 800 450'>
  ...
  <!-- Title -->
  <text x='400' y='130' font-family='Segoe UI, Arial, sans-serif' font-size='42' font-weight='bold' text-anchor='middle' fill='#2196f3'>
    Human-Centered AI
  </text>
  ...
  <!-- Learning Objective -->
  <text x='400' y='200' font-family='Segoe UI, Arial, sans-serif' font-size='18' font-weight='bold' text-anchor='middle' fill='#666'>
    Virtual Training Nugget 1.1.1
  </text>

  <!-- Framework Reference -->
  <text x='400' y='230' font-family='Segoe UI, Arial, sans-serif' font-size='14' font-weight='bold' text-anchor='middle' fill='#999'>
    Based on the UNESCO AI Competency Framework for Teachers
  </text>

  <!-- Collaboration info -->
  <text x='400' y='260' font-family='Segoe UI, Arial, sans-serif' font-size='14' font-weight='bold' text-anchor='middle' fill='#999'>
    A collaboration of the UNEVOC Network - ASSET Project
  </text>

  <!-- Academic reference -->
  <text x='400' y='300' font-family='Segoe UI, Arial, sans-serif' font-size='12' font-weight='bold' text-anchor='middle' fill='#999'>
    Acquire Level: Developing Critical Assessment Skills
  </text>
</svg>
...
- **Duration:** 15 minutes
- **Learning Level:** Acquire
- **Time Investment:** Self-paced with reflection checkpoints

**📋 Processing Modes:**
- **Self-Directed:** Work through content at your own pace
...
> **Current Focus: Acquire Level - Human-Centered Mindset**

| Competency | Acquire | Deepen | Create |
|------------|---------|--------|--------|
| **Human-centred Mindset** | @highlightCell(Critically reflect on benefits, limitations and risks of AI tools in local educational settings) | @normalCell(Apply human-centered principles in AI tool selection) | @normalCell(Design AI-enhanced learning experiences prioritizing human agency) |
...
> **Knowledge Check 1: Framework Application**
...
What would be your TOP priority before implementing this tool?
    ...
    [( )] Ensuring technical infrastructure can support it
...
**Your Task:** Identify specific human-centered AI violations and recommend alternatives.
...
> **Real-World Application: Automotive Diagnostics AI**
